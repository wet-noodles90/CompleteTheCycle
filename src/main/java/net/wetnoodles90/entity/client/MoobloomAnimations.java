...
public class MoobloomAnimations {
    ...
    public static final Animation ANIM_MOOBLOOM_IDLE = Animation.Builder.create(1f).looping()
    ...
    public static final Animation ANIM_MOOBLOOM_WALK = Animation.Builder.create(1f).looping()
